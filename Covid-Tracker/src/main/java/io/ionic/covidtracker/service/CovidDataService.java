    ...
    public void fetchVirusData() throws IOException, InterruptedException {
        ...
        for (CSVRecord record : records) {
            ...
            if(!record.get("Province/State").equals("")) {
                ...
                locationStats.setState("Unknown/ In " + record.get("Country/Region"));
            }
                ...
                int changeInCases = casesToday - casesYesterday;
                locationStats.setChangeFromYesterDay(Integer.parseInt(String.valueOf(changeInCases)));
